...
`)+`
`+m);const w=Q+C+f,R=Q+m+h,P=jm(l,l.VERTEX_SHADER,w),N=jm(l,l.FRAGMENT_SHADER,R);l.attachShader(M,P),l.attachShader(M,N),i.index0AttributeName!==void 0?l.bindAttribLocation(M,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(M,0,"position"),l.linkProgram(M);function F(H){if(o.debug.checkShaderErrors){const ot=l.getProgramInfoLog(M).trim(),at=l.getShaderInfoLog(P).trim(),ut=l.getShaderInfoLog(N).trim();let lt=!0,L=!0;if(l.getProgramParameter(M,l.LINK_STATUS)===!1)if(lt=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,M,P,N);else{const k=tE(l,P,"vertex"),V=tE(l,N,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(M,l.VALIDATE_STATUS)+`

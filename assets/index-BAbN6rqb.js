...
`].filter(Lo).join(`
`)),f=ph(f),f=eE(f,i),f=nE(f,i),h=ph(h),h=eE(h,i),h=nE(h,i),f=iE(f),h=iE(h),i.isRawShaderMaterial!==!0&&(U=`#version 300 es
...
`)+`
`+m);const D=U+v+f,b=U+m+h,P=jm(l,l.VERTEX_SHADER,D),G=jm(l,l.FRAGMENT_SHADER,b);l.attachShader(I,P),l.attachShader(I,G),i.index0AttributeName!==void 0?l.bindAttribLocation(I,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(I,0,"position"),l.linkProgram(I);function F(O){if(o.debug.checkShaderErrors){const st=l.getProgramInfoLog(I).trim(),nt=l.getShaderInfoLog(P).trim(),ut=l.getShaderInfoLog(G).trim();let lt=!0,L=!0;if(l.getProgramParameter(I,l.LINK_STATUS)===!1)if(lt=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,I,P,G);else{const q=tE(l,P,"vertex"),k=tE(l,G,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(I,l.VALIDATE_STATUS)+`
